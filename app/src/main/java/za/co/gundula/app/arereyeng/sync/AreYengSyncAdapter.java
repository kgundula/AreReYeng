...
public class AreYengSyncAdapter extends AbstractThreadedSyncAdapter {

    public final String LOG_TAG = AreYengSyncAdapter.class.getSimpleName();
    ...
    public AreYengSyncAdapter(Context context, boolean autoInitialize) {
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        AreYengSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
