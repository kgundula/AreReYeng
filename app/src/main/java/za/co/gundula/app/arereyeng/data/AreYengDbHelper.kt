 ...
 */
class AreYengDbHelper(context: Context?) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    override fun onCreate(db: SQLiteDatabase) {
        val SQL_CREATE_FARES_TABLE = "CREATE TABLE " + AreYengContract.FaresEntry.TABLE_NAME + "(" +
                ...
                " );"
        val SQL_CREATE_AGENCY_TABLE = "CREATE TABLE " + AreYengContract.AgencyEntry.TABLE_NAME + "(" +
                ...
                " );"
        val SQL_CREATE_FARE_PRODUCT_TABLE = "CREATE TABLE " + AreYengContract.FareProductEntry.TABLE_NAME + "(" +
        ...
        val SQL_CREATE_BUS_STOP_TABLE = "CREATE TABLE " + AreYengContract.BusStopEntry.TABLE_NAME + "(" +
        ...
        val SQL_CREATE_FAVOURITE_TABLE = "CREATE TABLE " + AreYengContract.FavoritesBusEntry.TABLE_NAME + "(" +
    ...
    companion object {
        ...
        const val DATABASE_NAME = "areyeng.db"
    }
}